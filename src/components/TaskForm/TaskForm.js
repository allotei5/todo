            ...
            <ModalBody>
                <form onSubmit={onSubmit}>
                    <div className="mb-3">
                        ...
                        <input required type="text" value={taskName} onChange={(e) => setTaskName(e.target.value)}  className="form-control" id="exampleFormControlInput1" placeholder="Finish this app" />
                    </div>
                    <div className="mb-3">
                        <label htmlFor="exampleFormControlTextarea1" className="form-label">Enter description</label>
                        <textarea required className="form-control" id="exampleFormControlTextarea1" onChange={(e) => setTaskDescription(e.target.value)} value={taskDescription} rows="3"></textarea>
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <input required type="date" className="form-control" id="exampleFormControlInput1" value={date} onChange={(e) => setDate(e.target.value)} />
                    </div>
                    <div className="mb-3">
                        <label htmlFor="exampleFormControlTextarea1" className="form-label">Enter Comments</label>
                        <textarea required className="form-control" id="exampleFormControlTextarea1" onChange={(e) => setComment(e.target.value)} value={comment} rows="3"></textarea>
                    </div>
